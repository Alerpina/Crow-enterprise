												...
												@endif
													<div class="extra-list">
														<ul>
															...
															<li>
															<span class="quick-view" rel-toggle="tooltip" title="{{ __("Quick View") }}" href="javascript:;" data-href="{{ route('product.quick',$prod->id) }}" data-toggle="modal" data-target="#quickview" data-placement="right"> <i class="icofont-eye-alt"></i>
															</span>
															</li>
															<li>
													...
													<div class="extra-list">
														<ul>
															<li>
																...
																<span class="add-to-wish" data-href="{{ route('user-wishlist-add',$prod->id) }}" data-toggle="tooltip" data-placement="right" title="{{ __("Add To Wishlist") }}" data-placement="right"><i class="icofont-ui-love-add"></i>
																</span>
