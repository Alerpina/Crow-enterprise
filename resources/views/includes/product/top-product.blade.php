													...
													<div class="extra-list">
														<ul>
															<li>
																...
																<span href="javascript:;" class="add-to-wish" data-href="{{ route('user-wishlist-add',$prod->id) }}" data-toggle="tooltip" data-placement="right" title="{{ __("Add To Wishlist") }}" data-placement="right"><i class="icofont-ui-love-add"></i>
																</span>
																@else
