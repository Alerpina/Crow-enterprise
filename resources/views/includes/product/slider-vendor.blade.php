...
<br>
<div class="col-lg-4">
    <img style="margin: 0 auto; display: flex;" width="50%" src="{{ $prod->user->photo ? asset('assets/images/users/'.$prod->user->photo ):asset('assets/images/noimage.png') }}" />
...
<div class="col-lg-6">
        ...
        <a target="_blank" href="{{ route('front.vendor',str_replace(' ', '-', $prod->user->shop_name)) }}"><button style="margin: 0 auto; display: flex;" class="btn btn-success">{{ __("Details") }}</button></a>
</div>
<div class="col-lg-2">
    <div class="info">
