							...
							enctype="multipart/form-data">
								...
								<div class="row border-sep"> <!--COMEÇO DA ROW DE DADOS OBRIGATORIOS-->
									...
									<div class="col-xl-6">
										<div class="input-form">
											...
											<input type="text" class="input-field" placeholder="{{ __("Product Affiliate Link") }}" name="affiliate_link" required="" value="{{ $data->affiliate_link }}">
										</div>
									</div>
								...
								<div class="row"> <!--COMEÇO DA ROW DE DADOS EXTRAS-->
									...
									<div class="col-xl-6">
										...
										<div class="input-form {{ !empty($data->size) ? "":"showbox" }}" id="size-display">
											<div class="row">
												<div class="col-xl-12">
															...
															<div class="size-area">
																...
																<div  class="row">
																	...
																	<div class="col-md-4 col-sm-6">
																		...
																		<input type="number" step="0.01" name="size_price[]" class="input-field" placeholder="{{ __("Size Price") }}" min="0" value="{{ $data->size_price[$key] }}">
																	</div>
																</div>
															</div>
														@endforeach
														@else 
															...
															<div  class="row">
																	...
																	<div class="col-md-4 col-sm-6">
																		...
																		<input type="number" step="0.01" name="size_price[]" class="input-field" placeholder="{{ __("Size Price") }}" value="0" min="0">
																	</div>
																</div>
															</div>
														@endif
