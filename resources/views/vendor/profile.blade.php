					...
					<div class="body-area">
						<div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<input type="text" class="input-field" name="vendor_corporate_name" placeholder="{{ __("Corporate Name") }}" required="" value="{{$data->vendor_corporate_name}}">
								</div>
							</div>
							<div class="row">
								<div class="col-lg-4">
								...
								<div class="col-lg-7">
									<input type="text" class="input-field" name="vendor_phone" placeholder="{{ __("Phone") }}" required="" value="{{$data->vendor_phone}}">
								</div>
							</div>
							<div class="row">
								<div class="col-lg-4">
								...
								<div class="col-lg-7">
									<input type="text" class="input-field" name="vendor_opening_hours" placeholder="{{ __("Opening Hours") }}" required="" value="{{$data->vendor_opening_hours}}">
								</div>
							</div>
							<div class="row">
								<div class="col-lg-4">
								...
								<div class="col-lg-7">
									<input type="text" class="input-field" name="vendor_payment_methods" placeholder="{{ __("Payment Methods") }}" required="" value="{{$data->vendor_payment_methods}}">
								</div>
							</div>
							<div class="row">
								<div class="col-lg-4">
								...
								<div class="col-lg-7">
									<input type="text" class="input-field" name="vendor_delivery_info" placeholder="{{ __("Delivery Info") }}" required="" value="{{$data->vendor_delivery_info}}">
								</div>
							</div>
							<div class="row">
								<div class="col-lg-4">
								...
								<div class="col-lg-7">
									<input type="text" class="input-field" name="reg_number" placeholder="{{ __("Registration Number") }}" value="{{$data->reg_number}}">
								</div>
							</div>
							<div class="row">
								<div class="col-lg-4">
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<input type="text" class="input-field" name="vendor_map_embed" placeholder="{{ __("Paste Google Maps Embed here") }}" value="{{$data->vendor_map_embed}}">
								</div>
							</div>
							<div class="row">
								<div class="col-lg-4">
