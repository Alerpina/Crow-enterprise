                                ...
                                <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                                    ...
                                    @endif
                                        ...
                                        @if($order->shipping_cost != 0)
                                            ...
                                            <tr class="no-border">
                                                <td colspan="1"></td>
                                                <td><strong>{{ Shipping::where('price','=',$price)->first()->title }}({{$order->currency_sign}})</strong></td>
                                        ...
                                        @if($order->packing_cost != 0)
                                            ...
                                            <tr class="no-border">
                                                <td colspan="1"></td>
                                                <td><strong>{{ Package::where('price','=',$pprice)->first()->title }}({{$order->currency_sign}})</strong></td>
