					...
					<div class="body-area">
						...
						<form id="geniusform" action="{{route('vendor-prod-update',$data->id)}}" method="POST"
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<select id="type_check" name="type_check">
										<option value="1" {{ $data->file != null ? 'selected':'' }}>{{ __("Upload By
											File") }}</option>
										<option value="2" {{ $data->link != null ? 'selected':'' }}>{{ __("Upload By
											Link") }}</option>
									</select>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<div class="img-upload">
										<div id="image-preview" class="img-preview" style="background: url({{filter_var($data->photo, FILTER_VALIDATE_URL) ? $data->photo :
												...
												<div class="row">
													...
													<div class="col-lg-6">
														<input type="number" min="1" name="license_qty[]"
															class="input-field" placeholder="{{ __(" License Quantity")
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<input name="youtube" type="text" class="input-field" placeholder="{{ __(" Youtube
										Video URL") }}" value="{{$data->youtube}}">
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<input type="text" class="input-field" placeholder="{{ __(" License Type") }}e"
...
<script type="text/javascript">
    ...
    let html = `<img src="{{ empty($data->photo) ? asset('assets/images/noimage.png') : asset('storage/images/products/'.$data->photo) }}" alt="">`;
