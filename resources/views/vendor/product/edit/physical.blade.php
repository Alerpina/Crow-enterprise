		...
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading"> {{ __("Edit Product") }} <a class="add-btn"
						href="{{ route('vendor-prod-index') }}"><i class="fas fa-arrow-left"></i> {{ __("Back") }}</a>
				</h4>
				<ul class="links">
					<li>
                                ...
                                <div class="col-xl-6">
                                    <div class="input-form">
                                        ...
                                        <input type="text" class="input-field"
                                            placeholder="{{ __('Enter Product Model Number') }}" name="mpn" required value="{{ $data->mpn }}">
                                    </div>
                                </div>
    ...
    '<div class="feature-area mb-3">'+
        ...
        '<div class="row mb-0">'+
            '<div class="col-lg-6">'+
                '<div class="panel panel-lang">'+
                    '<div class="panel-body">'+
                        '<div class="tab-content">'+
                            '<div role="tabpanel" class="tab-pane active" id="{{$lang->locale}}-features'+current_feature+'">'+
        ...
        '<div class="panel panel-lang">'+
            '<div class="panel-footer">'+
                '<ul class="nav nav-pills" role="tablist">'+
                    '<li role="presentation" class="active">'+
                        '<a href="#{{$lang->locale}}-features'+current_feature+'" class="active" aria-controls="{{$lang->locale}}-features'+current_feature+'"'+
                    ...
                    @foreach ($locales as $loc)
                        ...
                        @endif
                        '<li role="presentation">'+
                            '<a href="#{{$loc->locale}}-features'+current_feature+'" aria-controls="{{$loc->locale}}-features'+current_feature+'"'+
                                'role="tab" data-toggle="tab">'+
                                '{{$loc->language}}'+
                            '</a>'+
                        '</li>'+
