                      ...
                      <li>
                        ...
                        @include('includes.vendor.form-both')  
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __("Product Name") }}" name="name" required="">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input  name="youtube" type="text" class="input-field" placeholder="{{ __("Youtube Video URL") }}">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __("Product Platform") }}" name="platform">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __("Product Region") }}" name="region">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __("License Type") }}" name="licence_type">
													</div>
												</div>
