		...
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading">{{ __("Physical Product") }} <a class="add-btn"
						href="{{ route('vendor-prod-types') }}"><i class="fas fa-arrow-left"></i> {{ __("Back") }}</a>
				</h4>
				<ul class="links">
					<li>
							...
							<div class="row">
												...
												<div class="row">
													...
													<div class="col-md-3">
														<input type="number" step="0.01" name="color_price[]"
															class="input-field" placeholder="{{ __(" Color Price") }}"
															...
															<div class="row">
																<div class="col-lg-6">
																	<input type="number" name="whole_sell_qty[]"
																		class="input-field" placeholder="{{ __(" Enter
																		Quantity") }}" min="0">
																</div>
								...
								<div class="col-xl-3">
									<div class="input-form">
										...
										<input name="weight" type="number" class="input-field" placeholder="{{ __(" e.g
											20") }}" step="0.01" min="0">
									</div>
								</div>
								<!--FECHAMENTO COL-XL-3-->
								...
								<div class="col-xl-3">
									<div class="input-form">
										...
										<input name="width" type="number" class="input-field" placeholder="{{ __(" e.g
											20") }}" step="1" min="1">
									</div>
								</div>
								<!--FECHAMENTO COL-XL-3-->
