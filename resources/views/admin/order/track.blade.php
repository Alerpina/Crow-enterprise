                                    ...
                                    <td>
                                        <div class="action-list">
                                            <a data-href="{{ route('admin-order-track-update',$track->id) }}"
                                                class="track-edit"> <i class="fas fa-edit"></i>{{__('Edit')}}</a>
                                            <a href="javascript:;"
...
$('[name="{{$lang->locale}}[title]"]').val(title.find('[data-locale="{{$lang->locale}}"]').text());
...
@foreach($locales as $loc)
    @if($loc->locale === $lang->locale)
        @continue
    @endif
    $('[name="{{$loc->locale}}[title]"]').val(title.find('[data-locale="{{$loc->locale}}"]').text());
    $('[name="{{$loc->locale}}[text]"]').val(text.find('[data-locale="{{$loc->locale}}"]').text());
@endforeach
