    ...
    <div class="add-product-content">
      <div class="row product-description">
        <div class="col-lg-12 body-area">
          <form id="melhorenvio-request-form" action="{{ route('admin-order-select-melhorenvio-service') }}" method="POST"
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-lg-6">
                <input name="origin_zipcode" class="input-field"
                  value="{{ $origin_zipcode }}"
                  required>
              </div>
            </div>
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-lg-6">
                <input name="dest_zipcode" class="input-field"
                  value="{{ $dest_zipcode }}"
                  required>
              </div>
            </div>
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-lg-6">
                <input name="package[height]" class="input-field"
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-lg-6">
                <input name="package[width]" class="input-field"
                  value="{{ $package->width }}"
                  required type="number" step="1">
              </div>
            </div>
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-lg-6">
                <input name="package[length]" class="input-field"
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-lg-6">
                <input name="package[weight]" class="input-field"
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-lg-6">
                <input name="options[insurance_value]" class="input-field"
                  value="{{ round($options->insurance_value,2) }}"
            ...
            {{-- <div class="row justify-content-center">
              <div class="col-lg-3">
                <div class="left-area">
                  <h4 class="heading">{{ __('To collect') }}:
                  </h4>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="options[collect]" class="custom-control-input"
                    id="options[collect]" {{ $options->collect ? "checked" : "" }} value="1">
                  <label class="custom-control-label" for="options[collect]"></label>
                </div>
              </div>
            </div> --}}
