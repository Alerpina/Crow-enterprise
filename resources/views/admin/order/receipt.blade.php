        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <img class="zoom" id="preview" src="{{asset('assets/images/receipts/'.$order->receipt)}}" alt="">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                        <button type="submit" action="{{route('admin-order-manage-receipt', ['id' => $order->id, 'action' => 'accept'])}}" id="btnAccept" class="btn btn-success btn-ok btnManage">{{ __('Accept') }}</button>
                        <button type="submit" action="{{route('admin-order-manage-receipt', ['id' => $order->id, 'action' => 'reject'])}}" id="btnReject" class="btn btn-danger btn-ok btnManage">{{ __('Reject') }}</button>
                    </form>
                </div>
            </div>
