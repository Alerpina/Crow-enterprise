                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="invoice__logo text-left">
                            <img src="{{ asset('storage/images/'.$admstore->invoice_logo) }}" alt="woo commerce logo">
                        </div>
                    </div>
            ...
            <div class="row invoice__metaInfo">
                ...
                <div class="col-lg-6">
                    <div class="invoice__shipping">
                        ...
                        <span><strong>{{ __('District') }}</strong>:
                            {{ $order->shipping_district == null ? $order->customer_district : $order->shipping_district
                            }}</span><br>
                ...
                <div class="col-lg-6">
                    <div class="buyer">
                        ...
                        <span><strong>{{ __('Customer complement')}}</strong>: {{ $order->customer_complement
                            }}</span><br>
                                ...
                                <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            @endphp
                                            <td>{{$order->currency_sign}}{{ number_format($tax,
                                                $order_curr->decimal_digits,
                                                $order_curr->decimal_separator,$order_curr->thousands_separator) }}
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            @if($gs->is_invoice_photo)<td></td>@endif
                                            <td colspan="1"></td>
                                            <td>{{ __('Total') }}<br><small>{{ $first_curr->sign.' '.__('Total')
                                                    }}</small>
                                            </td>
