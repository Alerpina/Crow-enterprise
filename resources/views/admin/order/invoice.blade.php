                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="invoice__logo text-left">
                            <img src="{{ asset('assets/images/'.$admstore->invoice_logo) }}" alt="woo commerce logo">
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="invoice__shipping">
                        ...
                        <span><strong>{{ __('Number') }}</strong>:
                            {{ $order->shipping_address_number == null ? $order->customer_address_number." ".$order->customer_complement : $order->shipping_address_number." ".$order->shipping_complement }}</span><br>
                                ...
                                <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @if($gs->is_invoice_photo)
                                            <td width="10%">
                                                <img src="{{asset("assets/images/products")."/".$prod->photo}}" width="285" alt="">
                                            </td>
                                            @endif
                                            <td>
                                                @if($product['size'])
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$order->currency_sign}}{{ number_format($order->shipping_cost * $order->currency_value, $order_curr->decimal_digits, $order_curr->decimal_separator,$order_curr->thousands_separator) }}
                                            </td>
                                        </tr>
                                        @endif
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$order->currency_sign}}{{ number_format($order->packing_cost * $order->currency_value, $order_curr->decimal_digits, $order_curr->decimal_separator,$order_curr->thousands_separator) }}
                                            </td>
                                        </tr>
                                        @endif
                                        @if($order->tax != 0)
                                        <tr>
                                            ...
                                            @endphp
                                            <td>{{$order->currency_sign}}{{ number_format($tax, $order_curr->decimal_digits, $order_curr->decimal_separator,$order_curr->thousands_separator) }}
                                            </td>
                                        </tr>
                                        @endif
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$order->currency_sign}}{{ number_format($order->coupon_discount * $order->currency_value, $order_curr->decimal_digits, $order_curr->decimal_separator,$order_curr->thousands_separator) }}
                                            </td>
                                        </tr>
                                        @endif
                                        <tr>
