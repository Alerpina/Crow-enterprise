												...
												<div class="row flex-column justify-content-center align-items-center">
													...
													<div class="col-xl-4">
														<div class="input-form">
																...
																<input type="password" id="current_password" class="input-field" name="cpass" placeholder="{{__('Enter Current Password')}}" required="" value="">
													...
													<div class="col-xl-4">
														<div class="input-form">
																...
																<input type="password" id="new_password" class="input-field" name="newpass" placeholder="{{__('Enter New Password')}}" required="" value="">
													...
													<div class="col-xl-4">
														<div class="input-form">
															...
															<input type="password" id="retype_password" class="input-field" name="renewpass" placeholder="{{ __('Re-Type New Password') }}" required="" value="">
