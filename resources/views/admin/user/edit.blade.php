								...
								<div class="col-xl-6">
									...
									<div class="col-xl-6">
										<div class="input-form">
											...
											<input type="text" class="input-field" name="name" placeholder="{{ __(" User
												Name") }}" required="" value="{{ $data->name }}">
										</div>

										<div class="input-form">
											<h4 class="heading">{{ __("Phone") }} *</h4>
											<input type="text" class="input-field" name="phone" placeholder="{{ __("
												Phone Number") }}" required="" value="{{ $data->phone }}">
										</div>
									...
									<div class="col-xl-6">
										<div class="input-form">
											...
											<input type="email" class="input-field" name="email" placeholder="{{ __("
												Email Address") }}" value="{{ $data->email }}" disabled="">
										</div>
									...
									<div class="col-xl-6">
										<div class="input-form">
											...
											<input type="text" class="input-field" name="address" placeholder="{{ __("
												Address") }}" required="" value="{{ $data->address }}">
										</div>
									</div>
									...
									<div class="col-xl-4">
										<div class="input-form">
											...
											<input type="text" class="input-field" name="zip" placeholder="{{ __("
												Postal Code") }}" value="{{ $data->zip }}">
										</div>
									</div>
