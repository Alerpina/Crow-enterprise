                  ...
                  <div class="input-form">
                    ...
                    <div class="img-upload">
                      <div id="image-preview" class="img-preview"
                        style="background: url({{ $data->image ? asset('assets/images/brands/'.$data->image):asset('assets/images/noimage.png') }});">
                        @if ($data->image)
                        <div class="buttons">
                ...
                <div class="col-xl-6">
                  <div class="input-form">
                    ...
                    <div class="img-upload full-width-img">
                      <div id="image-preview" class="img-preview"
                        style="background: url('{{ $data->banner ? asset('assets/images/brands/banners/'.$data->banner):asset('assets/images/noimage.png') }}');">
                        <label for="image-upload" class="img-label" id="image-label"><i
                            class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
