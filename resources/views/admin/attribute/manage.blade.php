    ...
    <div class="row align-items-center">
      <div class="col-lg-12">
        ...
        <ul class="links d-inline-block">
          ...
          <li>
            @if (request()->input('type') == 'category')
            <a href="{{ route('admin-attr-manage', [$data->id, 'type' => 'category']) }}">{{__('Manage Attribute')}} </a>
            @endif
            @if (request()->input('type') == 'subcategory')
            <a href="{{ route('admin-attr-manage', [$data->id, 'type' => 'subcategory']) }}">{{__('Manage Attribute')}} </a>
            @endif
            @if (request()->input('type') == 'childcategory')
            <a href="{{ route('admin-attr-manage', [$data->id, 'type' => 'childcategory']) }}">{{__('Manage Attribute')}} </a>
            @endif
          </li>
        </ul>
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="nav nav-tabs" id="nav-tab" role="tablist">
        @if ($type == 'category')
        <a class="nav-item nav-link active" href="#" role="tab">{{ __('Category Attributes:')}} {{$data->name}}</a>
        @endif
        @if ($type == 'subcategory')
        <a class="nav-item nav-link active" href="#" role="tab">{{ __('Sub Category Attributes:')}} {{$data->name}}</a>
        @endif
        @if ($type == 'childcategory')
        <a class="nav-item nav-link active" href="#" role="tab">{{ __('Child Category Attributes:')}} {{$data->name}}</a>
        @endif
    </div>
    </div>
  </div>
