							...
							<div class="add-product-content">
								<div class="row">
									<div class="col-lg-12 p-5">
										  ...
										  <form id="bulkform" action="{{route('admin-prod-prepareImport')}}" method="POST" enctype="multipart/form-data">
											{{csrf_field()}}
											  ...
											  <div class="row justify-content-center" data-load="hide">
												  ...
												  <div class="col-lg-12 mt-3 d-flex justify-content-center text-center">
												  	<div class="checkbox-wrapper">
														<input type="checkbox" name="product_update_check" class="checkclick"
															id="updateCheck" value="1">
		...
		if (offset < rows) {
			...
			.fail((data) => {
				if(data.responseJSON.error) {
					...
					const message = 'Erro interno: ' + data.responseJSON.exception + ' - ' + data.responseJSON.message;
					bulkform.find('.alert-danger').show();
					$('<li>'+ data.errors.ref_code +'</li>').prependTo('.alert-danger .text-left')
				}
			})
