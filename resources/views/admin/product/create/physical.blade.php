    ...
    $("#color-btn-with-gallery").on('click', function(){
        $("#color-section").append(''+
            '<div class="row">'+
                ...
                '</div>'+
                '<div class="col-md-3">'+
                    '<input type="file" name="color_gallery['+count+'][]" id="uploadgallery_color" accept="image/*" multiple required>'+
                '</div>'+
                '<div class="col-md-1">'+
    ...
    $("#material-btn").on('click', function(){
        ...
        '<div class="row">'+
            ...
            '<div class="col-md-3">'+
                ...
                '</div>'+
                '<div class="col-md-3">'+
                                '<input type="number" step="0.01" name="material_price['+count_material+']" class="input-field"'+
