					...
					<div class="body-area">
						...
						<form id="geniusform" action="{{route('admin-prod-update',$data->id)}}" method="POST"
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<input name="price" type="number" class="input-field" placeholder="{{ __(" e.g 20")
										}}" step="0.01" value="{{round($data->price * $sign->value , 2)}}" required=""
										min="0">
								</div>
							</div>
									...
									<div class="col-lg-7">
										<div class="text-editor">
											<textarea name="meta_description" class="input-field" placeholder="{{ __("
												Details") }}">{{ $data->meta_description }}</textarea>
										</div>
									</div>
								</div>
							</div>
