  ...
  <div class="social-links-area">
    ...
    <form id="geniusform" class="form-horizontal" action="{{ route('admin-social-update-all') }}" method="POST">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <input class="form-control" name="facebook" id="facebook" placeholder="{{ __('https://facebook.com/') }}"
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <input class="form-control" name="twitter" id="twitter" placeholder="{{ __('https://twitter.com/') }}"
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <input class="form-control" name="linkedin" id="linkedin" placeholder="{{ __('https://linkedin.com/') }}"
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <input class="form-control" name="youtube" id="youtube" placeholder="{{ __('https://youtube.com/') }}"
            required="" type="text" value="{{$data->youtube}}">
        </div>
        <div class="col-sm-3">
          <label class="switch">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <input class="form-control" name="instagram" id="instagram" placeholder="{{ __('https://instagram.com/') }}"
            required="" type="text" value="{{$data->instagram}}">
        </div>
        <div class="col-sm-3">
          <label class="switch">
