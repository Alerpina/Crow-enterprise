      ...
      <div class="col-lg-12">
        <div class="product-description">
          <div class="body-area">
            ...
            <form id="geniusformdata" action="{{route('admin-subscription-update',$data->id)}}" method="POST"
              ...
              <div class="row">
                ...
                <div class="col-xl-4">
                  <div class="input-form">
                    ...
                    <input type="text" class="input-field" name="price" placeholder="{{ __("Enter Subscription Cost") }}"
                ...
                <div class="col-xl-4">
                  <div class="input-form">
                    ...
                    <input type="text" class="input-field" name="days" placeholder="{{ __("Enter Subscription Days") }}"
                    required="" value="{{ $data->days }}">
                  </div>
                </div>
                ...
                <div class="col-xl-4">
                  ...
                  <div class="input-form">
                    ...
                    <select id="limit" name="limit" required="">
                      ...
                      <option {{ $data->allowed_products == 0 ? "selected" : "" }} value="0">{{ __("Unlimited") }}
                      </option>
                      <option {{ $data->allowed_products != 0 ? "selected" : "" }} value="1">{{ __("Limited") }}</option>
                    </select>
                  </div>

                  <div class="input-form {{ $data->allowed_products == 0 ? 'showbox' : '' }}" id="limits">
                    <h4 class="heading">{{ __("Allowed Products") }} *</h4>
                    <input type="number" min="1" class="input-field" id="allowed_products" name="allowed_products"
