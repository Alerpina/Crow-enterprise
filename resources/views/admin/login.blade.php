            ...
            <div class="login-area">
              ...
              <div class="login-form">
                ...
                <form id="loginform" action="{{ route('admin.login.submit') }}" method="POST">
                  ...
                  <div class="form-input">
                    <input type="password" id="panel_password" name="password" class="Password" placeholder="{{ __('Type Password') }}">
                    <span toggle="#panel_password" class="fa fa-fw fa-eye field-icon toggle-panel"></span>
