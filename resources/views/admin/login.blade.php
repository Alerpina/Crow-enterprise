...
<head>
    ...
    <!-- trumbowyg css -->
    <link href="{{asset('admin/css/trumbowyg-all.min.css')}}" rel="stylesheet" />
    @yield('styles')
...
<body>
    ...
    <!-- Dashboard Core -->
    <script src="{{asset('admin/js/vendors/jquery-3.3.1.min.js')}}"></script>
    ...
    <!-- Load trumbo -->
    <script src="{{asset('admin/js/trumbowyg/plugins/resizimg/resizable-resolveconflict.js')}}"></script>
    <script src="{{asset('admin/js/jquery-resizable.js')}}"></script>
    <script src="{{asset('admin/js/trumbowyg/trumbowyg.min.js')}}">
        var trumbo_lang = "en";
    </script>
    @if (file_exists(public_path()."/admin/js/trumbowyg/langs/".$current_locale.".min.js"))
    <script>
        trumbo_lang = "{{str_replace('-','_',$current_locale)}}";
    </script>
    <script src="{{asset('admin/js/trumbowyg/langs/'.$current_locale.'.min.js')}}"></script>
    @endif
    <script src="{{asset('admin/js/trumbowyg/trumbowyg-all-plugins.min.js')}}"></script>
    <!-- -->
