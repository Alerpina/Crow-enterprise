                    ...
                    <div class="body-area">
                        ...
                        <form action="{{ route('admin-gs-update') }}" id="geniusform" method="POST"
                            ...
                            <div class="row ">
                                        ...
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1" value="{{route('admin-gs-issmtp',1)}}" {{
                                                    $admstore->is_smtp == 1 ? 'selected' : '' }}>{{ __('Activated') }}
                                                </option>
                                                <option data-val="0" value="{{route('admin-gs-issmtp',0)}}" {{
                                                    $admstore->is_smtp == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <input type="hidden" class="input-field" placeholder="{{ __('SMTP') }}" value="smtp"
                                    required="" readonly>
                                ...
                                <div class="col-xl-4">
                                    <div class="input-form">
                                        ...
                                        <input type="text" class="input-field" placeholder="{{ __('SMTP Username') }} "
                                            name="smtp_user" value="{{ $admstore->smtp_user }}">
