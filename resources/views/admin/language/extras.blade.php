        ...
        <div class="product-description">
          <div class="body-area">
            ...
            <form id="geniusform" action="{{route('admin-lang-update-extras',$data->id)}}" method="POST"
              ...
              <h4 class="text-center">{{ __('SET LANGUAGE KEYS & VALUES') }} - {{$data->language}}</h4>
                  ...
                  <div class="featured-keyword-area">
                    ...
                    <div class="lang-tag-top-filds" id="lang-section">
                      ...
                      <div class="lang-area">
                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <textarea name="keys[]" class="input-field" placeholder="{{ __('Enter Language Key') }}"
                              required="">{{ $key }}</textarea>
                          </div>

                          <div class="col-lg-6">
                            <textarea name="values[]" class="input-field" placeholder="{{ __('Enter Language Value') }}"
                    ...
                    <a href="javascript:;" id="lang-btn" class="add-fild-btn"><i class="icofont-plus"></i> {{ __('Add
                      More Field') }}</a>
                  </div>
                </div>
