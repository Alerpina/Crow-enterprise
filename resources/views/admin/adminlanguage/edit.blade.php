                                ...
                                <div class="col-xl-4">
                                    <div class="input-form">
                                        ...
                                        <select name="rtl" class="input-field" required="">
                                            <option value="0" {{ $data->rtl == '0' ? 'selected' : '' }}>{{ __('Left To
                                                Right') }}</option>
                                            <option value="1" {{ $data->rtl == '1' ? 'selected' : '' }}>{{ __('Right To
                                                Left') }}</option>
                                        </select>
                                    </div>
                                </div>
    ...
    var table = $('#geniustable').DataTable({
        ...
        initComplete: function(settings, json) {
            ...
            $('#btn-empty-search').on('click', function() {
                ...
                $('#btn-empty-search').css({display: "none"});
                $('#btn-all-search').css({display: ""});
            });

            $('#btn-all-search').on('click', function() {
                table.column(2).search("").draw();
                $('#btn-all-search').css({display: "none"});
                $('#btn-empty-search').css({display: ""});
            });
        }
    });
