...
<div class="content-area">
  <div class="mr-breadcrumb">
    <div class="row">
      <div class="col-lg-12">
        <h4 class="heading">{{ __('Best Seller') }} <i class="icofont-question-circle" data-toggle="tooltip" data-placement="top" title="{{__('Side banner that stay in the best-sellers section.')}}" style="font-size: 15px;"></i></h4>
        <ul class="links">
          <li>
              ...
              <div class="row">
                ...
                <div class="col-xl-6">
                  <div class="input-form">
                    ...
                    <div class="img-upload">
                      <div id="image-preview" class="img-preview"
                        style="background: url({{ $admstore->pagesettings->best_seller_banner ? asset('assets/images/'.$admstore->pagesettings->best_seller_banner):asset('assets/images/noimage.png') }});">
                        ...
                        <button type="button" class="btn btn-danger m-2 remove-banner" tipo="best_seller_banner">x</button>
                        @endif
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="input-form">
                    ...
                    <input type="text" class="input-field" name="best_seller_banner_link" placeholder="{{ __('Link') }}"
                ...
                <div class="col-xl-6">
                  <div class="input-form">
                    ...
                    <div class="img-upload">
                      <div id="image-preview" class="img-preview"
                        style="background: url({{ $admstore->pagesettings->best_seller_banner1 ? asset('assets/images/'.$admstore->pagesettings->best_seller_banner1):asset('assets/images/noimage.png') }});">
                        <label for="image-upload" class="img-label" id="image-label"><i
                            class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
                        <input type="file" name="best_seller_banner1" class="img-upload" id="image-upload">
                        @if($admstore->pagesettings->best_seller_banner1)
                        <button type="button" class="btn btn-danger m-2 remove-banner" tipo="best_seller_banner1">x</button>
                        @endif
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="input-form">
                    <h4 class="heading">{{ __('Link') }} <i class="icofont-question-circle" data-toggle="tooltip" style="display: inline-block " data-placement="top" title="{{ __('Link that will open when the object get clicked') }}"></i> </h4>
                    <input type="text" class="input-field" name="best_seller_banner_link1" placeholder="{{ __('Link') }}"
