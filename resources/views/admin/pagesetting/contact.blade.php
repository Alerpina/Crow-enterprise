            ...
            <div class="action-list godropdown">
              <select id="store_filter" class="process select go-dropdown-toggle">
                ...
                <option value="{{ route('admin-stores-isconfig',['id' => $store['id'], 'redirect' => true]) }}"
                  {{$store['id'] == $admstore->pagesettings->id ? 'selected' : ''}}>{{$store['domain']}}</option>
                @endforeach
              </select>
            </div>
          </li>
              ...
              <div class="row">
                ...
                <div class="col-xl-6">
                  ...
                  <div class="input-form">
                    ...
                    <input type="email" class="input-field" placeholder="{{ __('Enter Email') }}" name="email"
                    value="{{ $admstore->pagesettings->email }}">
                  </div>

                  <div class="input-form">
                    <h4 class="heading">{{ __('Website') }}
                    </h4>
                    <input type="text" class="input-field" placeholder="{{ __('Enter Website') }}" name="site"
                  ...
                  <div class="input-form">
                    ...
                    <input type="text" class="input-field" placeholder="{{ __('Enter Phone') }}" name="phone"
                    value="{{ $admstore->pagesettings->phone }}">
                  </div>
                ...
                <div class="col-xl-6">
                  <div class="input-form">
                    ...
                    <input type="text" class="input-field" placeholder="{{ __('Contact Us Email Address') }}"
                    name="contact_email" value="{{ $admstore->pagesettings->contact_email }}">
                  </div>

                  <div class="input-form">
                    <h4 class="heading">{{ __('Fax') }}
                    </h4>
                    <input type="text" class="input-field" placeholder="{{ __('Enter Fax') }}" name="fax"
                    value="{{ $admstore->pagesettings->fax }}">
                  </div>
                </div>
