                        ...
                        <div class="action-list godropdown">
                            <select id="store_filter" class="process select go-dropdown-toggle">
                                ...
                                <option
                                    ...
                                    {{$store['id']==$admstore->pagesettings->id ? 'selected' : ''}}>{{$store['domain']}}
                                </option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="input-form">
                                        @component('admin.components.input-localized',["from" =>
                                        $admstore->pagesettings, "type" => "richtext"])
                                        @slot('name')
                                        contact_title
                                        @endslot
                                        @slot('value')
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="input-form">
                                        ...
                                        <input type="text" class="input-field" placeholder="{{ __('Enter Website') }}"
                                            name="site" value="{{ $admstore->pagesettings->site }}">
                                    </div>
                                    ...
                                    <div class="input-form">
                                        ...
                                        <div class="tawk-area">
                                            <textarea name="street"
                                                placeholder="{{__('Enter Street Address')}}"> {{ $admstore->pagesettings->street }} </textarea>
                                        </div>
                                    </div>
                                </div>
