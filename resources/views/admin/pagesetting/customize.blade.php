              ...
              <div class="row row-cols-1 row-cols-md-4">
                ...
                <div class="col-md-4 mb-4">
                  <div class="card card-settings h-100">
                    ...
                    <div class="card-body p-3">
                      <p class="card-text">{{ __('Show the main categories marked as featured using a different block.')
                        }}</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                  <div class="card card-settings h-100">
                    ...
                    <div class="card-body p-3">
                      <p class="card-text">{{ __('Show banners above the content, side by side, in a retangular
                        format.') }}</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                  <div class="card card-settings h-100">
                    ...
                    <div class="card-body p-3">
                      <p class="card-text">{{ __('Show only one banner among the content in a retangular format.') }}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                  <div class="card card-settings h-100">
                    <div class="card-header d-flex justify-content-between">
                      ...
                      <label class="switch">
                        <input type="checkbox" name="bottom_small" value="1" {{$admstore->pagesettings->bottom_small ==
                        1 ? "checked":""}}>
                        <span class="slider round"></span>
                      </label>
                    </div>
                    <div class="card-body p-3">
                      <p class="card-text">{{ __('Show banners below the content, side by side, in a retangular
                        format.') }}</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                  <div class="card card-settings h-100">
                    ...
                    <div class="card-body p-3">
                      <p class="card-text">{{ __('Show a block listing products marked as either hot, new, trending or
                        sales, with a small size.') }}</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 mb-4">
                  <div class="card card-settings h-100">
                    <div class="card-header d-flex justify-content-between">
                      ...
                      <label class="switch">
                        <input type="checkbox" name="reviews_store" value="1" {{$admstore->pagesettings->reviews_store
                        == 1? "checked": ""}}>
                        <span class="slider round"></span>
                      </label>
                    </div>
                ...
                <div class="col-md-4 mb-4">
                  <div class="card card-settings h-100">
                    <div class="card-header d-flex justify-content-between">
                      ...
                      <label class="switch">
                        <input type="checkbox" name="blog_posts" value="1" {{$admstore->pagesettings->blog_posts == 1?
                        "checked": ""}}>
                        <span class="slider round"></span>
                      </label>
                    </div>
              ...
              <div class="row row-cols-1 row-cols-md-4">
                <div class="col-md-4 mb-4">
                  <div class="card card-settings h-100">
                    ...
                    <div class="card-body p-3">
                      <p class="card-text">{{ __('Banners and sliders will be show in a random order instead of the
                        order specified in the record.') }}</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 mb-4">
