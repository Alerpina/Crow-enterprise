                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="input-form">
                                        ...
                                        <input type="email" class="input-field" name="email" placeholder="{{ __(" Email
                                            Address") }}" required="" value="{{ $data->email }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="input-form">
                                        ...
                                        <input type="text" class="input-field" name="phone" placeholder="{{ __(" Phone
                                ...
                                <div class="col-xl-6">
                                    <div class="input-form">
                                        ...
                                        <select name="role_id" required="">
                                            ...
                                            <option value="{{ $dta->id }}" {{ $data->role_id == $dta->id ? 'selected' :
                                                '' }}>{{ $dta->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
