                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="input-form">
                                        ...
                                        <input type="password" id="staff_password" class="input-field" name="password" placeholder="{{ __("Password") }}" required="" value="">
                                        <span toggle="#staff_password" class="fa fa-fw fa-eye field-icon toggle-password"></span>
                                    </div>
                                </div>
