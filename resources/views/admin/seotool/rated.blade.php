						...
						<table id="example" class="table table-hover dt-responsive" cellspacing="0" width="100%">
							<thead>
								<tr>
									<th>{{ __('Name') }}</th>
									<th>{{ __('Category') }}</th>
									<th><i class="icofont-star icofont-lg" data-toggle="tooltip" title='{{ __("Rating") }}'></i></th>
								</tr>
							</thead>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="{{ route('front.product', $prod->slug)}}" target="_blank">{{mb_strlen($prod->name,'utf-8') > 60 ? mb_substr($prod->name,0,60,'utf-8').'...' : $prod->name}} </a>
									</td>
