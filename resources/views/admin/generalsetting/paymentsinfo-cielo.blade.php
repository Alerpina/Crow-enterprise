                                    ...
                                    <div class="row">
                                                ...
                                                <div class="action-list">
                                                    <select
                                                        ...
                                                        <option data-val="1" value="{{route('admin-gs-cielo',1)}}"
                                                            {{ $admstore->is_cielo == 1 ? 'selected' : '' }}>{{ __('Activated') }}
                                                        </option>
                                        ...
                                        <div class="col-xl-5">
                                            <div class="input-form">
                                                <h4 class="heading">{{ __('Cielo MerchantId') }} *
                                                    <span><i class="icofont-question-circle" data-toggle="tooltip" data-placement="top" title="{{__('Consult your Merchant ID (MID) with the payment method provider.')}}"></i></span>
                                                </h4>
                                                <textarea class="input-field" name="cielo_merchantid"
                                                placeholder="{{ __('Cielo MerchantId') }}">{{ $admstore->cielo_merchantid }}</textarea>
                                        ...
                                        <div class="col-xl-5">
                                            <div class="input-form">
                                                ...
                                                cielo_text
                                                @endslot
                                                {{ __('Cielo Text') }} * <span><i class="icofont-question-circle" data-toggle="tooltip" data-placement="top" title="{{__('Enter the message that will be displayed to the customer when using the payment method.')}}" style="margin-top: -120px; margin-right:42px;"></i></span>
                                                @endcomponent
