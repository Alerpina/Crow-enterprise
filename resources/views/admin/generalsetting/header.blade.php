          ...
          <div class="body-area">
            ...
            <form id="geniusform" action="{{ route('admin-gs-update') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <div class="tawk-area">
                    <input type="text" class="input-field" placeholder="{{ __('Header Email') }}" name="header_email"
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <div class="tawk-area">
                    <input type="text" class="input-field" placeholder="{{ __('Header Phone') }}" name="header_phone"
