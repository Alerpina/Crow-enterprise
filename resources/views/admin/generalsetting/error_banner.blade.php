              ...
              <div class="row">
                ...
                <div class="col-xl-5">
                  <div class="input-form">
                    <h4 class="heading"> {{ __('Banner Image') }} * <i class="icofont-question-circle" data-toggle="tooltip" style="display: inline-block " data-placement="top" title="{{ __('Banner that will appear when the link cannot be found') }}"></i>
                    <span>{{ __('(Preferred Size: 600 X 600 Pixel)') }}</span>
                    </h4>
              
                    <div class="img-upload">
                      <div id="image-preview" class="img-preview"
                        style="position:relative;background: url({{ $admstore->error_banner ? asset('assets/images/'.$admstore->error_banner):asset('assets/images/noimage.png') }});">
                  ...
                  <div class="input-form">
                    @component('admin.components.input-localized',["from" => $admstore, "type" => "richtext"])
                      ...
                      @slot('value')
                        page_not_found_text
                      @endslot
                      {{ __('Page Not Found Text') }} * <i class="icofont-question-circle" data-toggle="tooltip" style="display: inline-block " data-placement="top" title="{{ __('Text that will appear when the link cannot be found') }}"></i>
                    @endcomponent
                  </div>
                </div>
