                                    ...
                                    <div class="row">
                                                ...
                                                <div class="action-list">
                                                    <select
                                                        ...
                                                        <option data-val="1" value="{{route('admin-gs-paypal',1)}}"
                                                            {{ $admstore->is_paypal == 1 ? 'selected' : '' }}>{{ __('Activated') }}
                                                        </option>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="input-form">
                                                ...
                                                paypal_text
                                                @endslot
                                                {{ __('PayPal Text') }} * <span><i class="icofont-question-circle" data-toggle="tooltip" data-placement="top" title="{{__('Enter the message that will be displayed to the customer when using the payment method.')}}" style="margin-top: -120px; margin-right:42px;"></i></span>
                                                @endcomponent
