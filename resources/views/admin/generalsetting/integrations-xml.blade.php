                                ...
                                <form action="{{ route('admin-gs-update') }}" id="geniusform" method="POST"
                                        ...
                                        <div class="col-xl-12">
                                            <div class="input-form input-form-center">
                                                ...
                                                <div class="action-list godropdown">
                                                    <select id="store_select" class="process select go-dropdown-toggle">
                                                        @foreach ($stores as $store)
                                                        <option
                                                            value="{{ route('admin-gs-storecomprasparaguai', ['id' => $store['id']]) }}"
                                                            {{ $store['id']==$admstore->store_comprasparaguai ?
                                                            'selected' : '' }}>
                                                            {{ $store['domain'] }}</option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="input-form">
                                            ...
                                            <p>
                                                <a target="__blank"
                                                    href="{{ asset('assets/files/comprasparaguai.xml') }}">{{
                                                    asset('assets/files/comprasparaguai.xml') }}</a>
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="input-form">
                                                ...
                                                <p>
                                                    <a target="__blank"
                                                        href="{{ asset('assets/files/googleshopping.xml') }}">{{
                                                        asset('assets/files/googleshopping.xml') }}</a>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="input-form">
                                                ...
                                                <p>
                                                    <a target="__blank"
                                                        href="{{ asset('assets/files/facebookbusiness.xml') }}">{{
                                                        asset('assets/files/facebookbusiness.xml') }}</a>
                                                </p>
                                            </div>
                                        </div>
