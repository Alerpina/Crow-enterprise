                                        ...
                                        @if (config('features.compras_paraguai'))
                                            ...
                                            <div class="col-xl-12">
                                                <div class="input-form">
                                                    ...
                                                    <p>
                                                        <a target="__blank" href="{{ asset('assets/files/comprasparaguai.xml') }}">{{ asset('assets/files/comprasparaguai.xml') }}</a>
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="input-form">
                                                    ...
                                                    <p>
                                                        <a target="__blank" href="{{ asset('assets/files/googleshopping.xml') }}">{{ asset('assets/files/googleshopping.xml') }}</a>
                                            ...
                                            <div class="col-xl-12">
                                                <div class="input-form">
                                                    ...
                                                    <p>
                                                        <a target="__blank" href="{{ asset('assets/files/facebookbusiness.xml') }}">{{ asset('assets/files/facebookbusiness.xml') }}</a>
                                                    </p>
                                                </div>
                                            </div>
