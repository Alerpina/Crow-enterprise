                                    ...
                                    <div class="row">
                                            ...
                                            <div class="input-form input-form-center">
                                                ...
                                                <div class="action-list">
                                                    <select
                                                        ...
                                                        <option data-val="1" value="{{route('admin-gs-pagseguro',1)}}"
                                                            {{ $admstore->is_pagseguro == 1 ? 'selected' : '' }}>
                                                            {{ __('Activated') }}</option>
                                                        <option data-val="0" value="{{route('admin-gs-pagseguro',0)}}"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="input-form">
                                                <h4 class="heading">{{ __('PagSeguro Email') }} *
                                                    <span><i class="icofont-question-circle" data-toggle="tooltip" data-placement="top" title="{{__('Your PagSeguro E-mail.')}}"></i></span>
                                                </h4>
                                                <textarea class="input-field" name="pagseguro_email"
                                                placeholder="{{ __('PagSeguro Email') }}">{{ $admstore->pagseguro_email }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="input-form">
                                                ...
                                                <textarea class="input-field" name="pagseguro_token"
                                                placeholder="{{ __('PagSeguro Token') }}">{{ $admstore->pagseguro_token }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="input-form">
                                                ...
                                                pagseguro_text
                                                @endslot
                                                {{ __('PagSeguro Text') }} * <span><i class="icofont-question-circle" data-toggle="tooltip" data-placement="top" title="{{__('Enter the message that will be displayed to the customer when using the payment method.')}}" style="margin-top: -120px; margin-right:42px;"></i></span>
                                                @endcomponent
