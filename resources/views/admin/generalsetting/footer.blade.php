                  ...
                  <div class="input-form">
                    @component('admin.components.input-localized',["from" => $admstore, "type" => "textarea"])
                      ...
                      @slot('value')
                        footer
                      @endslot
                      {{ __('Footer Text') }}  * <i class="icofont-question-circle" data-toggle="tooltip" style="display: inline-block " data-placement="top" title="{{ __('Title that will appear on the footer') }}"></i>
                    @endcomponent
                  </div>
                </div>
                  ...
                  <div class="input-form">
                    @component('admin.components.input-localized',["from" => $admstore, "type" => "richtext"])
                      ...
                      @slot('value')
                        copyright
                      @endslot
                      {{ __('Copyright Text') }}   *<i class="icofont-question-circle" data-toggle="tooltip" style="display: inline-block " data-placement="top" title="{{ __('Copyright text that will appear on the footer') }}"></i>
                    @endcomponent
                  </div>
                </div>
