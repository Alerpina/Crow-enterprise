                    ...
                    <div class="action-list">
                      <select
                        ...
                        <option data-val="1" value="{{route('admin-gs-maintain',1)}}"
                          {{ $admstore->is_maintain == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                        <option data-val="0" value="{{route('admin-gs-maintain',0)}}"
                          {{ $admstore->is_maintain == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                      </select>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="action-list">
                      <select
                        ...
                        <option data-val="1" value="{{route('admin-gs-darkmode',1)}}"
                          {{ $admstore->is_dark_mode == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                        <option data-val="0" value="{{route('admin-gs-darkmode',0)}}"
                          {{ $admstore->is_dark_mode == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                      </select>
                    </div>
                  </div>
                </div>
