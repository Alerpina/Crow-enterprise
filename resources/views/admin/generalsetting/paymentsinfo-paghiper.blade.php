                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="input-form">
                                                ...
                                                <input type="number" min="0" max="400" class="input-field"
                                                    name="paghiper_days_due_date"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="input-form input-form-center">
                                                ...
                                                <div class="action-list">
                                                    <select
                                                        ...
                                                        <option data-val="1"
                                                            value="{{route('admin-gs-paghiper-pix',1)}}" {{ $admstore->
                                                            is_paghiper_pix == 1 ? 'selected' : '' }}>{{ __('Activated')
                                                            }}
                                                        </option>
                                                        <option data-val="0"
                                                            value="{{route('admin-gs-paghiper-pix',0)}}" {{ $admstore->
                                                            is_paghiper_pix == 0 ? 'selected' : '' }}>
                                                            {{ __('Deactivated') }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="input-form">
                                                ...
                                                <input type="number" min="0" max="400" class="input-field"
                                                    name="paghiper_pix_days_due_date"
                                                    placeholder="{{ __('Calendar days to maturity. 0 to 400 days.') }}"
