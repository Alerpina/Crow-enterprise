                        ...
                        <form action="{{ route('admin-gs-update') }}" id="geniusform" method="POST"
                            ...
                            <div class="row">
                                        ...
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1" value="{{route('admin-gs-islanguage',1)}}" {{
                                                    $admstore->is_language == 1 ? 'selected' : '' }}>{{ __('Activated')
                                                    }}</option>
                                        ...
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1" value="{{route('admin-gs-iscurrency',1)}}" {{
                                                    $admstore->is_currency == 1 ? 'selected' : '' }}>{{ __('Activated')
                                                    }}</option>
                                ...
                                <div class="col-xl-3">
                                    <div class="input-form">
                                        <h4 class="heading">
                                            {{__('Reverse Currency Highlight') }} <i class="icofont-question-circle"
                                                data-toggle="tooltip" style="display: inline-block "
                                                data-placement="top"
                                        ...
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1" value="{{route('admin-gs-ishome',1)}}" {{
                                                    $admstore->is_home == 1 ? 'selected' : '' }}>{{ __('Activated') }}
                                                </option>
                                                <option data-val="0" value="{{route('admin-gs-ishome',0)}}" {{
                                                    $admstore->is_home == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1" value="{{route('admin-gs-isfaq',1)}}" {{
                                                    $admstore->is_faq == 1 ? 'selected' : '' }}>{{ __('Activated') }}
                                                </option>
                                                <option data-val="0" value="{{route('admin-gs-isfaq',0)}}" {{
                                                    $admstore->is_faq == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1" value="{{route('admin-gs-iscontact',1)}}" {{
                                                    $admstore->is_contact == 1 ? 'selected' : '' }}>{{ __('Activated')
                                                    }}</option>
                                                <option data-val="0" value="{{route('admin-gs-iscontact',0)}}" {{
                                                    $admstore->is_contact == 0 ? 'selected' : '' }}>{{ __('Deactivated')
                                                    }}</option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1" value="{{route('admin-gs-isblog',1)}}" {{
                                                    $admstore->is_blog == 1 ? 'selected' : '' }}>{{ __('Activated') }}
                                                </option>
                                                <option data-val="0" value="{{route('admin-gs-isblog',0)}}" {{
                                                    $admstore->is_blog == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1" value="{{route('admin-gs-ispopup',1)}}" {{
                                                    $admstore->is_popup == 1 ? 'selected' : '' }}>{{ __('Activated') }}
                                                </option>
                                                <option data-val="0" value="{{route('admin-gs-ispopup',0)}}" {{
                                                    $admstore->is_popup == 0 ? 'selected' : '' }}>{{ __('Deactivated')
                                                    }}</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1" value="{{route('admin-gs-iswhatsapp',1)}}" {{
                                                    $admstore->is_whatsapp == 1 ? 'selected' : '' }}>{{ __('Yes') }}
                                                </option>
                                                <option data-val="0" value="{{route('admin-gs-iswhatsapp',0)}}" {{
                                                    $admstore->is_whatsapp == 0 ? 'selected' : '' }}>{{ __('No') }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3">
                                    <div class="input-form">
                                        <h4 class="heading">
                                            {{ __('Captcha') }} <i class="icofont-question-circle" data-toggle="tooltip"
                                        ...
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1" value="{{route('admin-gs-iscapcha',1)}}" {{
                                                    $admstore->is_capcha == 1 ? 'selected' : '' }}>{{ __('Activated') }}
                                                </option>
                                                <option data-val="0" value="{{route('admin-gs-iscapcha',0)}}" {{
                                                    $admstore->is_capcha == 0 ? 'selected' : '' }}>{{ __('Deactivated')
                                                    }}</option>
                                            </select>
                                        </div>
                                    </div>
