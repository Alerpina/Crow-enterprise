        ...
        <div class="special-box bg-gray">
          ...
          <form class="uplogo-form" id="geniusform" action="{{ route('admin-gs-update') }}" method="POST"
            ...
            <div class="currrent-logo">
              <img
                src="{{ $admstore->logo ? asset('assets/images/'.$admstore->logo):asset('assets/images/noimage.png')}}"
                alt="">
            </div>
            <div class="set-logo">
      ...
      <div class="col-xl-4 col-md-6">
        <div class="special-box  bg-gray">
          ...
          <form class="uplogo-form" id="geniusform" action="{{ route('admin-gs-update') }}" method="POST"
            ...
            <div class="currrent-logo">
              <img
                src="{{ $admstore->footer_logo ? asset('assets/images/'.$admstore->footer_logo):asset('assets/images/noimage.png')}}"
                alt="">
            </div>
            <div class="set-logo">
      ...
      <div class="col-xl-4 col-md-6">
        <div class="special-box  bg-gray">
          ...
          <form class="uplogo-form" id="geniusform" action="{{ route('admin-gs-update') }}" method="POST"
            ...
            <div class="currrent-logo">
              <img
                src="{{ $admstore->invoice_logo ? asset('assets/images/'.$admstore->invoice_logo):asset('assets/images/noimage.png')}}"
                alt="">
            </div>
