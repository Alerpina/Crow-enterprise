                                    ...
                                    <div class="row">
                                                ...
                                                <div class="action-list">
                                                    <select
                                                        ...
                                                        <option data-val="1" value="{{route('admin-gs-rede',1)}}"
                                                            {{ $admstore->is_rede == 1 ? 'selected' : '' }}>{{ __('Activated') }}
                                                        </option>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="input-form">
                                                ...
                                                <textarea class="input-field" name="rede_installments"
                                                placeholder="{{ __('Number of installments.') }}">{{ $admstore->rede_installments }}</textarea>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="input-form">
                                                ...
                                                @php
                                                    clock($admstore);
                                                @endphp
                                                <textarea class="input-field" name="rede_token"
                                                    placeholder="{{ __('Token') }}">{{ $admstore->rede_token }}</textarea>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="input-form">
                                                ...
                                                <textarea class="input-field" name="rede_pv"
                                                placeholder="{{ __('PV') }}">{{ $admstore->rede_pv }}</textarea>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="input-form">
                                                ...
                                                rede_text
                                                @endslot
                                                {{ __('Rede Text') }} * <span><i class="icofont-question-circle" data-toggle="tooltip" data-placement="top" title="{{__('Enter the message that will be displayed to the customer when using the payment method.')}}" style="margin-top: -120px; margin-right:42px;"></i></span>
                                                @endcomponent
