      ...
      <div class="col-lg-12">
        <div class="product-description">
          <div class="body-area">
            ...
            <form action="{{ route('admin-gs-update-popup') }}" id="geniusform" method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="row">
                ...
                <div class="col-xl-6">
                  <div class="input-form">
                    <h4 class="heading">{{ __('Feature Image') }} <span><i class="icofont-question-circle" data-toggle="tooltip" data-placement="top" title="{{ __('Image will be adjusted based on screen resolution. Recommended size: 1024x600.') }}"></i></span></h4>
                    <div class="row">
                      ...
                      @if($admstore->popup_background)
                        ...
                        @endif
                        <div class="span4 cropme text-center" id="landscape" style="width: 400px; height: 225px; border: 1px dashed black;background: url({{ $admstore->popup_background ? asset('assets/images/'.$admstore->popup_background):asset('assets/images/noimage.png') }}); background-size: cover;">
                        </div>
                ...
                <input type="hidden" id="feature_photo" name="popup_background" value="{{ $gs->popup_background }}">
