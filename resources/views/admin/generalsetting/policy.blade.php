              ...
              <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="input-form">
                        ...
                        policy
                        @endslot
                        {{ __('Buy/Return Policy') }} <i class="icofont-question-circle" data-toggle="tooltip" style="display: inline-block " data-placement="top" title="{{ __('Text that will appear on the Buy/Return Policy page') }}"></i>
                        @endcomponent
                    </div>
                </div>
