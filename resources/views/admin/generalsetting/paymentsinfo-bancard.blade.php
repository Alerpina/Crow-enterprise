                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4">
                                            <div class="input-form input-form-center">
                                                <h4 class="heading">{{ __('Bancard Sandbox Check') }} *
                                                    <span><i class="icofont-question-circle" data-toggle="tooltip" data-placement="top" title="{{__('Enable the sandbox mode to make payment tests only, it will not work for real purchases.')}}"></i>
                                                    </span>
                                                </h4>
                                                <label class="switch">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="input-form">
                                                <h4 class="heading">{{ __('Bancard Public Key') }} *
                                                    <span>
                                                        <i class="icofont-question-circle" data-toggle="tooltip" data-placement="top" title="{{__('Consult your public key with the payment method provider.')}}"></i>
                                                    </span>
                                                </h4>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="input-form">
                                                <h4 class="heading">{{ __('Bancard Private Key') }} *
                                                    <span>
                                                        <i class="icofont-question-circle" data-toggle="tooltip" data-placement="top" title="{{__('Consult your private key with the payment method provider.')}}"></i>
                                                    </span>
                                                </h4>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="input-form">
                                                ...
                                                bancard_text
                                                @endslot
                                                {{ __('Bancard Text') }} * <span><i class="icofont-question-circle" data-toggle="tooltip" data-placement="top" title="{{__('Enter the message that will be displayed to the customer when using the payment method.')}}" style="margin-top: -120px; margin-right:42px;"></i></span>
                                                @endcomponent
