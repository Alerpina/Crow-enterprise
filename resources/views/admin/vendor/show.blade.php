                                            ...
                                            <td>
                                                ...
                                                <a class="set-gallery1" href="javascript:;" data-toggle="modal"
                                                    data-target="#setgallery"><input type="hidden"
                                                        value="{{ $data->verifies()->where('status','=','Verified')->first()->id }}">({{
                                                    __('View') }})</a>
                                                @else
                                                <a class="badge badge-danger verify-link" href="javascript:;">{{
                                                    __('Unverified') }}</a>
                                                @endif
                                            </td>
                                            <td>
                                ...
                                <div class="table-responsive">
                                    <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><a href="{{ route('front.product', $dt->slug) }}" target="_blank">{{
                                                        sprintf("%'.08d",$dt->id) }}</a></td>
                                                <td>{{ $dt->type }}</td>
                                                @php
						  ...
						  if(data[0] == 0)
						  {
							...
							$('.selected-image .row').append('<div class="col-sm-6">'+
											'<div class="img gallery-img">'+
												'<a class="img-popup" href="'+'{{asset('storage/images/attachments').'/'}}'+arr[k]+'">'+
												'<img  src="'+'{{asset('storage/images/attachments').'/'}}'+arr[k]+'" alt="gallery image">'+
												'</a>'+
											'</div>'+
										  '</div>');
							  }
