                                                ...
                                                <table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>{{ __("Plan") }}</th>
                                                            <th><i class="icofont-clock-time icofont-lg" data-toggle="tooltip" title='{{ __("Purchase Time") }}'></i></th>
                                                        </tr>
                                                    </thead>
                                                </table>
                                        </div>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
        ...
        var table = $('#geniustable').DataTable({
               ...
               language : {
                  url: '{{$datatable_translation}}',                    processing: '<img src="{{asset('assets/images/'.$gs->admin_loader)}}">'
                },
...
$(document).ready(function(){
    ...
    $(document).on('click', 'a', function(e){ 
        ...
        y = x.split("/");
        if(!(link.attr("data-href") || link.attr("href").indexOf("#") > -1 || link.attr("href").indexOf("javascript") > -1 || !(link.attr("href").indexOf("vendors/subs")))){
            sessionStorage.setItem("CurrentPage", 0);
            table.state.clear();
        }
    });
