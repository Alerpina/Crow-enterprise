...
<script>
	$(document).ready(function(){
		...
		$(document).on('click', 'a', function(e){
			...
			if(!(link.attr("data-href") || link.attr("href").indexOf("#") > -1 || link.attr("href").indexOf("javascript") > -1  || link.attr("href").indexOf("vendors/subs") > -1 || link.attr("href").indexOf("vendors") > -1)){
				sessionStorage.setItem("CurrentPage", 0);
				table.state.clear();
			}
		});
