                    ...
                    <div class="panel-body">
                      ...
                      <div class="form-group">
                        <div class="col-sm-12">
                          <div class="row">
                            <div class="col-sm-4">
                              <label class="control-label" for="title_size">{{ __('Font Size') }}</label>
                              <input class="form-control" type="number" name="title_size" value="" min="1" placeholder="Em pixels">
                            </div>
                            <div class="col-sm-4">
                    ...
                    <div class="panel-body">
                      ...
                      <div class="form-group">
                        <div class="col-sm-12">
                          <div class="row">
                            <div class="col-sm-4">
                              <label class="control-label" for="subtitle_size">{{ __('Font Size') }}</label>
                              <input class="form-control" type="number" name="subtitle_size" value="" min="1" placeholder="Em pixels">
                            </div>
                            <div class="col-sm-4">
                    ...
                    <div class="panel-body">
                      ...
                      <div class="form-group">
                        <div class="col-sm-12">
                          <div class="row">
                            <div class="col-sm-4">
                              <label class="control-label" for="details_size">{{ __('Font Size') }} </label>
                              <input class="form-control" type="number" name="details_size" value="" min="1" placeholder="Em pixels">
                            </div>
                            <div class="col-sm-4">
