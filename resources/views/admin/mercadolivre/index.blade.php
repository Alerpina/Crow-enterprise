                            ...
                            <div class="col-lg-9">
                                <form action="{{ route('admin-gs-integrations-mercadolivre-update') }}" id="geniusform"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="input-form">
                                                <h4 class="heading">{{ __('Mercado Livre Authorization Code, Access &
                                                    Refresh Token') }} *
                                                    <span>({{ __('Get all Mercado Livre credentials by simply clicking
                                                        the button below.') }})</span>
                                                </h4>
                                                <a class="btn btn-success" target="_blank"
                                                    href="https://auth.mercadolivre.com.br/authorization?response_type=code&client_id={{ $meli->app_id }}&redirect_uri={{ $meli->redirect_uri }}">{{
                                                    __("Get it here") }}</a>
                                                <p>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="input-form">
                                                ...
                                                <p>{{ __("This URL is always the same. You need to configure your
                                                    Redirect URL at Mercado Livre with this URL.") }}</p>
                                            </div>
                                        </div>
