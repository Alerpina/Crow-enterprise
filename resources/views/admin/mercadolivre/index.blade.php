                    ...
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    <form action="{{ route('admin-gs-integrations-mercadolivre-update') }}" id="geniusform" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="input-form">
                                                    ...
                                                    <textarea class="input-field" name="app_id"
                                                        placeholder="{{ __('Token') }}">{{ $meli->app_id }}</textarea>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="input-form">
                                                    ...
                                                    <textarea class="input-field" name="client_secret"
                                                        placeholder="Client Secret">{{ $meli->client_secret }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-12">
                                                <div class="input-form">
                                                    <h4 class="heading">{{ __('Mercado Livre Authorization Code, Access & Refresh Token') }} *
                                                        <span>({{ __('Get all Mercado Livre credentials by simply clicking the button below.') }})</span>
                                                    </h4>
                                                    <a class="btn btn-success" target="_blank" href="https://auth.mercadolivre.com.br/authorization?response_type=code&client_id={{ $meli->app_id }}&redirect_uri={{ $meli->redirect_uri }}">{{ __("Get it here") }}</a>
                                                    <p>
                                                        <b>{{ $meli->authorization_code }}</b>
                                                    </p>
                                                    <p> {{ __("Updated at") }}: {{ \Carbon\Carbon::parse($meli->updated_at)->format('d-m-Y H:i:s') }} </p>
                                                </div>
                                            </div>
                                            @endif
                                            <div class="col-xl-4">
                                                <div class="input-form">
                                                    ...
                                                    <p>
                                                        <textarea class="input-field" name="redirect_uri"
                                                        placeholder="Client Secret">{{ $meli->redirect_uri }}</textarea>
                                                    </p>
                                                    <p>{{ __("This URL is always the same. You need to configure your Redirect URL at Mercado Livre with this URL.") }}</p>
                                                </div>
                                            </div>
