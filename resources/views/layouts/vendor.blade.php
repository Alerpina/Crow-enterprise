					...
					<div class="d-flex justify-content-between">
						...
						<div class="text-center" style="width: 20%">
							<img style="width: 100%;
								...
								margin: 1rem;" src="{{ asset('storage/images/').'/'.$gs->footer_logo }}" alt="">
						</div>
					...
					<ul class="list-unstyled components" id="accordion">
						...
						<li>
							<a target="_blank"
								...
								class="wave-effect active"><i class="fas fa-eye mr-2"></i> <span>{{ __("Visit Store")
									}}</span></a>
						</li>
						...
						<li>
							<a href="#order" class="accordion-toggle wave-effect" data-toggle="collapse"
								aria-expanded="false"><i class="fas fa-hand-holding-usd"></i> <span>{{ __("Orders")
									}}</span></a>
						...
						<li>
							...
							<ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
								<li>
									<a href="{{ route('vendor-prod-index') }}"><span>{{ __("Add New Product")
											}}</span></a>
								</li>
							</ul>
						</li>
						...
						{{-- <li>
							<a href="{{ route('vendor-prod-import') }}"><i class="fas fa-upload"></i><span>{{ __("Bulk
									Product Upload") }}</span></a>
						</li>
						<li>
							<a href="{{ route('vendor-wt-index') }}" class=" wave-effect"><i
									class="fas fa-list"></i><span>{{ __("Withdraws") }}</span></a>
						</li> --}}
						...
						<li>
							...
							<ul class="collapse list-unstyled" id="general" data-parent="#accordion">
								...
								<li>
									<a href="{{ route('vendor-subscription-index') }}"><span>{{ __("Subscription")
											}}</span></a>
								</li>
								<li>
								...
								@endif
								<li>
									<a href="{{ route('vendor-social-index') }}"><span>{{ __("Social Links")
											}}</span></a>
								</li>
							</ul>
						</li>
