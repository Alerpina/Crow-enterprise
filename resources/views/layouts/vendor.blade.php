...
<head>
	...
	<body>
					...
					<div class="container-fluid">
						<div class="d-flex justify-content-between">
							...
							<div class="text-center" style="width: 20%">
								...
								margin: 1rem;" src="{{ asset('assets/images/').'/'.$gs->footer_logo }}" alt="">
							</div>
											...
											<div class="dropdownmenu-wrapper">
													<ul>
														<h5>{{ __("Welcome!") }}</h5>
															...
															<li>
																<a target="_blank" href="#"><i class="fas fa-bookmark"></i> {{ __("Plan") }}</a>
															</li>
															...
															<li>
																<a href="{{ route('user-reset') }}"><i class="fas fa-lock"></i> {{ __("Change Password") }}</a>
															</li>
															<li>
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
							...
							<li>
								<a target="_blank" href="{{ route('front.vendor',str_replace(' ', '-', Auth::user()->shop_name)) }}" class="wave-effect active"><i class="fas fa-eye mr-2"></i> <span>{{ __("Visit Store") }}</span></a>
							</li>

							<li>
								<a href="{{ route('vendor-dashboard') }}" class="wave-effect active"><i class="fa fa-home mr-2"></i><span>{{ __("Dashbord") }}</span></a>
							</li>
							@if($gs->is_cart)
							<li>
								<a href="#order" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false"><i class="fas fa-hand-holding-usd"></i> <span>{{ __("Orders") }}</span></a>
								<ul class="collapse list-unstyled" id="order" data-parent="#accordion" >
                                   	<li>
                                    	<a href="{{route('vendor-order-index')}}"><span>{{ __("All Orders") }}</span></a>
                                	</li>
								</ul>
							</li>
							@endif
							...
							<li>
								...
								<ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
									<li>
										<a href="{{ route('vendor-prod-index') }}"><span>{{ __("Add New Product") }}</span></a>
									</li>
								</ul>
							</li>
							...
							{{-- <li>
								<a href="#affiliateprod" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
									<i class="icofont-cart"></i><span>{{ __("Affiliate Products") }}</span>
								</a>
							...
							{{-- <li>
								<a href="{{ route('vendor-prod-import') }}"><i class="fas fa-upload"></i><span>{{ __("Bulk Product Upload") }}</span></a>
							</li>
							<li>
								<a href="{{ route('vendor-wt-index') }}" class=" wave-effect"><i class="fas fa-list"></i><span>{{ __("Withdraws") }}</span></a>
							</li> --}}
							...
							<li>
								...
								<ul class="collapse list-unstyled" id="general" data-parent="#accordion">
									<li>
										<a href="{{ route('vendor-profile') }}"><span> {{ __("Edit Profile") }}</span></a>
									</li>
									<li>
										<a href="{{ route('vendor-subscription-index') }}"><span>{{ __("Subscription") }}</span></a>
									</li>
                                    <li>
		...
		<script src="{{asset('assets/admin/js/trumbowyg/trumbowyg.min.js')}}">var trumbo_lang = "en";</script>
		@if (file_exists(public_path()."/assets/admin/js/trumbowyg/langs/".$current_locale.".min.js"))
		<script> trumbo_lang = "{{str_replace('-','_',$current_locale)}}"; </script>
