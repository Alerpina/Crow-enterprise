								...
								<ul class="list">
									...
									<li class="bell-area">
										<a id="notifications" class="dropdown-toggle-1" href="javascript:;">
											...
											<span data-href="{{ route('admin.notifications-count') }}" id="notifications-count">{{ $notifications_count }}</span>
										</a>
										<div class="dropdown-menu">
											<div class="dropdownmenu-wrapper" data-href="{{ route('admin.notifications-show') }}" id="notifications-show">
										</div>
										</div>
									</li>
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
							<li>
								<a href="{{ route('admin.dashboard') }}" class="wave-effect active"><i class="ion-pie-graph"></i>{{ __('Dashboard') }}</a>
							</li>
