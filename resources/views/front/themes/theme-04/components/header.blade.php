                            ...
                            <ul class="helpful-links-inner">
                                ...
                                <li class="my-dropdown">
                                    <a href="javascript:;" class="cart carticon">
                                        <div class="icon">
                                            ...
                                            <img src="{{ asset('project/resources/views/front/themes/theme-04/assets/images/cartheader.png')}}" class="img-fluid icons-header" alt="Carrinho">
                                        </div>
                                    </a>
                                ...
                                <li class="wishlist" data-toggle="tooltip" data-placement="top" title="{{ __("Wish") }}">
                                    ...
                                    <a href="{{ route('user-wishlists') }}" class="wish">
                                        ...
                                        <img src="{{ asset('project/resources/views/front/themes/theme-04/assets/images/loveheader.png')}}" class="img-fluid icons-header" alt="Amei">
                                    </a>
                                    @else
                                ...
                                <li class="compare" data-toggle="tooltip" data-placement="top" title="{{ __("Compare") }}">
                                    <a href="{{ route('product.compare') }}" class="wish compare-product">
                                        <div class="icon">
                                            ...
                                            <img src="{{ asset('project/resources/views/front/themes/theme-04/assets/images/comparar.png')}}" class="img-fluid icons-header" alt="Comparar">
                                        </div>
                                    </a>
                                </li>
