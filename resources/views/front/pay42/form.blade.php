                    ...
                    <div class="col-10 m-auto">
                        <div class="form-group mt-4 text-center" >
                            <h3>{{ __("Total Purchase") }}
                                <span class="badge badge-light" style="border: 1px solid; color: #615993;">{{$pedido->currency_sign}} {{ number_format((float)($pedido->pay_amount * $pedido->currency_value ), 2, '.', '') }}</span>
                            </h3>
                        </div>
                    </div>
                </div>
