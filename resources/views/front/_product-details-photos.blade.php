    ...
    <div class="xzoom-container">
        ...
        <div class="xzoom-thumbs">
            <div class="all-slider">
                ...
                <a href="{{$ftp_image}}">
                    <img class="xzoom-gallery5" width="80" src="{{$ftp_image}}" title="The description goes here">
                </a>
                @endif
                @endforeach
                @else
                ...
                <a href="{{asset('storage/images/galleries/'.$gal->photo)}}">
                    <img class="xzoom-gallery5" width="80" src="{{asset('storage/images/galleries/'.$gal->photo)}}"
                        title="The description goes here">
                </a>
                @endforeach
                @endif
        ...
        <div class="xzoom-thumbs">
            <div class="all-slider-color-gallery">
                ...
                <a href="{{asset('storage/images/color_galleries/'.$gal)}}"
                    ...
                    <img class="xzoom-gallery5" width="80" src="{{asset('storage/images/color_galleries/'.$gal)}}"
                        title="The description goes here">
                </a>
                @endforeach
                @endif
        ...
        <div class="xzoom-thumbs">
            <div class="all-slider-material-gallery">
                ...
                <a href="{{asset('storage/images/material_galleries/'.$gal)}}"
                    ...
                    <img class="xzoom-gallery5" width="80" src="{{asset('storage/images/material_galleries/'.$gal)}}"
                        title="The description goes here">
                </a>
                @endforeach
                @endif
