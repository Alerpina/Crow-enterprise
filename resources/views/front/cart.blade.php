                    ...
                    <div class="cart-table">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                @php
                                $custom_item_id =
                                $product['item']['id'].$product['size'].$product['color'].$product['material'].$product['customizable_gallery'].$product['customizable_name'].$product['customizable_number'].$product['customizable_logo'].str_replace(str_split('
                                ,'),'',$product['values']);
                                $custom_item_id = str_replace( array( '\'', '"', ',', '.', ' ', ';', '<', '>' ), '' ,
                          ...
                          asset('assets/images/products/'.$product['item']['photo'])}}" alt="product">
                                    ...
                                    <td>
                                        ...
                                        $product['values'])) as $key =>
                                        $value)
                                        <b>{{ App\Models\Attribute::where('input_name', $key)->first()->name }} : </b>
                                        {{$value}} <br>
                                        @endforeach
        ...
        $.ajax({
            ...
            success: function(data) {
              ...
              country_id = "";
                ...
                if(data.error) {
                  var html = '<p class="PAC-sheep border rounded p-1"><small>' + data.error + '</small></p>';
