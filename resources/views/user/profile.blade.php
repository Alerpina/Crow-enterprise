...
<script>
  ...
  $('#billCountry').change(function(e, zipdata) {
    ...
    $.ajax({
      ...
      success: function(data) {
        if(zipdata) {
          $('#billState').html('<option value="'+zipdata['state_id']+'">'+zipdata['state_name']+'</option>').trigger('change', zipdata);
        } else {
  ...
  $('#billState').change(function(e, zipdata) {
    ...
    $.ajax({
      ...
      success: function(data) {
        if(zipdata) {
          $('#billCity').html('<option value="'+zipdata['city_id']+'">'+zipdata['city']+'</option>').trigger('change');
        } else {
