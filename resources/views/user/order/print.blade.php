                                ...
                                <div class="row reorder-xs">
                                    <div class="col-lg-8 col-md-5 col-sm-5 col-xs-12">
                                        <div class="product-header-title">
                                            <h2>{{ __("Order#") }} {{$order->order_number}} [{{__($order->status)}}]
                                            </h2>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="dashboard-content">
                                                <div class="view-order-page" id="print">
                                                    <p class="order-date" style="margin-left: 2%">{{ __("Order Date") }}
                                                    ...
                                                    <div class="billing-add-area">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <p>{{ __("Paid Amount:") }} {{$order->currency_sign}}{{
                                                                    number_format($order->pay_amount *
                                                    ...
                                                    <div class="invoice__metaInfo">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <p>{{ __('Discount:') }} {{$order->currency_sign}}{{
                                                            ...
                                                            <p>{{ $first_curr->sign.' '.__('Total:') }}
                                                                ...
                                                                $first_curr->thousands_separator) }}</p>
                                                            <p>{{ __("Payment Method:") }} {{$order->method}}</p>
                                                        ...
                                                        <div class="col-md-6" style="width: 50%;">
                                                            ...
                                                            <address>
                                                                {{ __("Name:") }} {{$order->shipping_name == null ?
                                                                $order->customer_name : $order->shipping_name}}<br>
                                                                {{ __("Phone:") }} {{$order->shipping_phone == null ?
                                                                $order->customer_phone : $order->shipping_phone}}<br>
                                                                {{ __("Address:") }} {{$order->shipping_address == null
                                                            ...
                                                            <p>
                                                                ...
                                                                number_format($order->packing_cost *
                                                                $order->currency_value , $order_curr->decimal_digits,
                                                                $order_curr->decimal_separator,$order_curr->thousands_separator)
                                                                }}<br>
                                                            ...
                                                            <table id="example" class="table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>{{mb_strlen($product['item']['name'],'utf-8')
                                                                            > 25 ?
                                                                        ...
                                                                        <td style="text-align: end;">
                                                                            ...
                                                                            * $order->currency_value ,
                                                                            $order_curr->decimal_digits,
                                                                            $order_curr->decimal_separator,$order_curr->thousands_separator)}}
                                                                            <br><small>{{$first_curr->sign}}{{
                                                                                number_format($product['item']['price'],
                                                                                $first_curr->decimal_digits,$first_curr->decimal_separator,$first_curr->thousands_separator)
                                                                                }}</small>
                                                                        </td>
                                                                        <td style="text-align: end;">
