                ...
                <div class="user-profile-details">
                    <div class="order-details">
                        ...
                        <div class="view-order-page">
                            <h3 class="order-code">{{ __("Order#") }} {{$order->order_number}} [{{ __($order->status) }}]
                            </h3>
                            ...
                            <div class="billing-add-area">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p>{{ __("Payment Status") }}:
                                             {!! $order->payment_status == 'Pending' ? "<span class='badge badge-danger'>". __("Unpaid") ."</span>":"<span class='badge badge-success'>". __("Paid") ."</span>" !!}
                                        </p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p>     
                                            ...
                                            {{ __('Discount:') }} {{$order->currency_sign}}{{ number_format($order->coupon_discount * $order->currency_value, $order_curr->decimal_digits, $order_curr->decimal_separator,$order_curr->thousands_separator) }}<br>
                                            @endif
                                            {{ __("Paid Amount:") }} {{$order->currency_sign}}{{ number_format($order->pay_amount * $order->currency_value, $order_curr->decimal_digits, $order_curr->decimal_separator,$order_curr->thousands_separator) }}<br>
                                            ...
                                            @else
                                            {{ $first_curr->sign.' '.__('Total:') }} {{$first_curr->sign}}{{ number_format($order->pay_amount, $first_curr->decimal_digits, $first_curr->decimal_separator,$first_curr->thousands_separator) }}<br>
                                            </p>
                                            @endif
                                        ...
                                        <tr>
                                            ...
                                            <td width="40%">
                                                ...
                                                @if(env("ENABLE_CUSTOM_PRODUCT") || env("ENABLE_CUSTOM_PRODUCT_NUMBER"))
                                                    ...
                                                    <b>{{ __("Custom Name") }}</b>: {{ $product['customizable_name'] }}<br>
                                                    @endif
                                                @endif
                                                @if(env("ENABLE_CUSTOM_PRODUCT_NUMBER"))
                                                    @if(!empty($product['customizable_number']))
                                                    <b>{{ __("Custom Number") }}</b>: {{ $product['customizable_number'] }}<br>
                                                    @endif
                                                @endif
                                                @if(env("ENABLE_CUSTOM_PRODUCT"))
                                                    @if(!empty($product['customizable_gallery']))
                                                        <b>{{ __("Custom Gallery") }}</b>: <img src="{{ asset("assets/images/thumbnails/".$product['customizable_gallery']) }}" width="100px"><br>
                                                    @endif
                                                    @if(!empty($product['customizable_logo']))
                                                        <b>{{ __("Custom Logo") }}</b>: <img src="{{ asset("assets/images/custom-logo/".$product['customizable_logo']) }}" width="100px"><br>
                                                    @endif
                                                @endif
