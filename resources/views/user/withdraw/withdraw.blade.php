                        ...
                        <form id="userform" class="form-horizontal" action="{{route('user-wwt-store')}}" method="POST"
                            ...
                            <div id="bank" style="display: none;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input name="iban" value="{{ old('iban') }}" placeholder="{{ __(" Enter
                                            IBAN\/Account No") }}" class="form-control" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input name="acc_name" value="{{ old('accname') }}" placeholder="{{ __(" Enter
                                            Account Name") }}" class="form-control" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input name="address" value="{{ old('address') }}" placeholder="{{ __(" Enter
                                            Address") }}" class="form-control" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input name="swift" value="{{ old('swift') }}" placeholder="{{ __(" Enter Swift
                                            Code") }}" class="form-control" type="text">
                                    </div>
                                </div>
