                            ...
                            <div class="edit-info-area">
                                ...
                                <div class="body">
                                        <div class="edit-info-area-form">
                                                ...
                                                <form id="userform" action="{{route('user-reset-password', ['token' => $token] )}}" method="POST" enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                                <input type="password" name="password"  class="input-field" placeholder="{{ __("New Password") }}" value="" required="">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-12">
