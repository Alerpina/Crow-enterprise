...
// -------------------------------- HOME PAGE SECTION ----------------------------------------
	...
	public function index(Request $request)
    {
        ...
        return view('front.index', compact(
            'sliders', 'top_small_banners', 'feature_products', 'categories',
            'reviews','large_banners','bottom_small_banners','best_products',
            'top_products','hot_products','latest_products','big_products',
            'trending_products','sale_products','discount_products',
            'partners','extra_blogs'
        ));
	}
...
// -------------------------------- RECEIPT SECTION----------------------------------------
    ...
    public function receiptSearch($order_number){
        ...
        if($data){
            ...
            } else if($data->receipt != null && $data->method = "Bank Deposit"){
        ...
        } else return response()->json(['success' => false, "msg" => "Pedido não encontrado."]);
    }
