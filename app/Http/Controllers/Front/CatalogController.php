...
class CatalogController extends Controller
{
  ...
  public function product($slug)
  {
    ...
    $ftp_path = public_path('assets/images/ftp/'.$this->storeSettings->ftp_folder.$productt->ref_code_int.'/');
    $ftp_gallery=[];
    if(File::exists($ftp_path)){
      ...
      foreach($files as $file){
        ...
        if(in_array($file_extension, $extensions) === true){
          $ftp_gallery[]=asset('assets/images/ftp/'.$this->storeSettings->ftp_folder.$productt->ref_code_int.'/'.$file);
        }
      }
    }
    ...
    foreach($category_gallery as $gallery){
      ...
      if($gallery->thumbnail == null){
        ...
        if (!file_exists(public_path().'/assets/images/thumbnails/'.$gallery->customizable_gallery)) {
          ...
          if($gallery->update()){
            $img_dir = public_path().'/assets/images/galleries/'.$gallery->customizable_gallery;
            $thumb_dir = public_path().'/assets/images/thumbnails/'.$gallery->customizable_gallery;
