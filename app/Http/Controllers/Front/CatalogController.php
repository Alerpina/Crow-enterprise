...
class CatalogController extends Controller
{
  ...
  // CATEGORIES SECTOPN
    ...
    public function comment(Request $request)
    {
        ...
        $data[0] = $comment->user->photo ? url('storage/images/users/' . $comment->user->photo) : url('storage/images/noimage.png');
    ...
    public function reply(Request $request, $id)
    {
        ...
        $data[0] = $reply->user->photo ? url('storage/images/users/' . $reply->user->photo) : url('storage/images/noimage.png');
