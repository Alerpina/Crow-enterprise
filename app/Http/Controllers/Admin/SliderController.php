...
class SliderController extends Controller
{
    ...
    public function datatables(){
        ...
        return Datatables::of($datas)
            ...
            ->addColumn('name', function(Slider $data){
                return $data->name;
            })
            ->addColumn('updated_at', function (Slider $data) {                 
                $date= $data->updated_at;
                $str='<div class="action-list">' . $date . '</div>';
                return ($str);
            })
    ...
    public function store(Request $request){
        ...
        if ($file = $request->file('photo')){      
            ...
            $file->move('assets/images/sliders',$slider_name);           
